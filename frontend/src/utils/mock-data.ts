...
export const mockProjects: ProjectSite[] = [
  {
    ...
    name: 'Silvassa Unit I - Polyester Division',
    clientName: 'Bhilosa Industries Private Limited',
    location: 'Silvassa, UT of DNH & DD',
    ...
    status: 'Active',
    budget: 850000000,
    actualSpend: 54000000,
    propertyType: 'Textile Manufacturing Plant',
    overview: 'High-Capacity Draw Texturised Yarn (DTY) & Fully Drawn Yarn (FDY) Manufacturing Division.',
    image: '/bhilosa-logo.svg',
    dailyActivities: [],
    materials: [],
    boqItems: [],
    procurements: [],
  ...
  {
    id: 'dadra-plant-02',
    name: 'Dadra Yarn Spinning Plant',
    clientName: 'Bhilosa Industries Private Limited',
    location: 'Dadra, UT of DNH & DD',
    ...
    status: 'Active',
    budget: 620000000,
    actualSpend: 38000000,
    propertyType: 'Yarn Spinning & Texturising',
    overview: 'Air Texturised Yarn (ATY) and Partially Oriented Yarn (POY) Spinning Plant.',
    image: '/bhilosa-logo.svg',
    dailyActivities: [],
    materials: [],
    boqItems: [],
  ...
  {
    id: 'naroli-knitted-03',
    name: 'Naroli Knitted Fabric Unit',
    clientName: 'Bhilosa Industries Private Limited',
    location: 'Naroli, UT of DNH & DD',
    ...
    status: 'Active',
    budget: 450000000,
    actualSpend: 29000000,
    propertyType: 'Circular & Warp Knitting Plant',
    overview: 'Warp Knitted Greige Fabric & Circular Knitted Greige Fabric Production Division.',
    image: '/bhilosa-logo.svg',
    dailyActivities: [],
    materials: [],
    boqItems: [],
...
export const initialMockVendors: Vendor[] = [
  {
    id: 'v-001',
    name: 'Reliance Polyester Raw Materials Ltd',
    gstNumber: '24AAACR5489E1ZI',
    email: 'supply@reliancepolyester.com',
    phone: '+91 98250 12345',
    address: 'Plot 45, GIDC Industrial Estate, Hazira, Surat, Gujarat - 394510',
    category: 'Raw Materials & Polymers',
    rating: 96,
  },
  {
    id: 'v-002',
    ...
    address: 'Industrial Complex, Butibori, Nagpur, Maharashtra',
    category: 'Yarn Chips & Auxiliaries',
    rating: 92,
  },
  {
    id: 'v-003',
    name: 'Textile Auxiliaries & Dyes Corp',
    gstNumber: '24AABCT9876G1Z2',
    email: 'sales@dyescorp.in',
    phone: '+91 98980 99887',
    address: 'Vapi Industrial Estate, Vapi, Gujarat',
