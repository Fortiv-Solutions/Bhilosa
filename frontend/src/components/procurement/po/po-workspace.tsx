    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-border bg-card p-2.5 shadow-sm">
        <div className="flex items-center gap-2 px-1 text-xs">
          ...
          <span className="font-bold text-foreground font-heading">Purchase Order (PO) Workspace</span>
          <span className="text-muted-foreground">• Active POs ({purchaseOrders.length})</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <ListChecks className="h-3.5 w-3.5" /> PO Table Overview ({filteredOrders.length})
          </button>
        </div>
      </div>
