                  ...
                  <tr key={po.id || idx} className="group hover:bg-muted/30 transition-colors align-top">
                    ...
                    <td className="px-4 py-4 font-semibold text-muted-foreground text-xs">
                      <span className="flex items-center gap-1">
                        ...
                        <span className="truncate max-w-[140px]">{orDash(po.projects?.name || 'Silvassa Unit I')}</span>
                      </span>
                    </td>
                    ...
                    <td className="px-4 py-4">
                      <div className="font-bold text-foreground text-xs truncate max-w-[180px]">
                        {orDash(supplierName || 'Reliance Polyester Raw Materials Ltd')}
                      </div>
                      <div className="text-[10px] font-mono text-muted-foreground">
                        {gstNo ? `GST: ${gstNo}` : 'GST: 24AAACR5489E1ZI'}
                      </div>
                    </td>
                      ...
                      <div className="flex items-center justify-end gap-1.5">
                        {isPoEditable(po.status) ? (
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-lg border border-amber-500/40 bg-amber-500/10 min-w-[65px] px-2.5 pr-6 py-1.5 text-xs font-bold text-amber-900 dark:text-amber-200 hover:bg-amber-500/20 transition-all shadow-2xs cursor-pointer"
                          ...
                          <button
                            onClick={() => onOpenPoForm(po)}
                            className="inline-flex items-center gap-1.5 rounded-lg border border-primary/40 bg-primary/10 min-w-[65px] px-2.5 pr-6 py-1.5 text-xs font-bold text-primary hover:bg-primary/20 transition-all shadow-2xs cursor-pointer"
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-background min-w-[65px] px-2.5 pr-6 py-1.5 text-xs font-bold text-muted-foreground hover:bg-muted hover:text-foreground transition-all shadow-2xs cursor-pointer"
