...
export function GrnForm({
  ...
  const [form, setForm] = useState<FullGrnFormState>(() => {
    ...
    return {
      ...
      project_name: grn.project_name && grn.project_name !== '—' ? grn.project_name : 'Silvassa Unit I - Polyester Division',
      company_name: (grn as any).company_name || 'Bhilosa Industries Private Limited',
      supplier_name: grn.vendor_name && grn.vendor_name !== '—' ? grn.vendor_name : 'Reliance Polyester Raw Materials Ltd',
      phone_no: (grn as any).phone_no || '+91 98250 12345',
      mobile_no: (grn as any).mobile_no || '+91 98250 12345',
      godown_name: grn.godown_name && grn.godown_name !== '—' ? grn.godown_name : 'Silvassa Raw Material Godown',
