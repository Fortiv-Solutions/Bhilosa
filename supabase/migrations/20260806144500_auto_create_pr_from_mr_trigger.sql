-- Auto-create Draft Purchase Requisitions from submitted Material Requests trigger
...
BEGIN
  ...
  -- Note: We run this as a simple update, checking to avoid infinite recursion
