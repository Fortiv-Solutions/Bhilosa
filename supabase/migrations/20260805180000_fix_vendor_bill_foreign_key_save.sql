-- =====================================================================
-- Migration: Fix Vendor Bill Save Foreign Key Violation (save_purchase_bill RPC)
-- Description: Ensures save_purchase_bill verifies that v_id exists in vendor_bills
--              before performing UPDATE. If v_id does not exist, it inserts a new row
--              so that vendor_bill_lines foreign key is guaranteed to be satisfied.
-- =====================================================================
